...
export default function DashBoard() {
  ...
  const overview = useMemo(() => {
    ...
    const remainingBudget = totalProjectCost - totalExpenses;
            ...
            <section className="overview">
              ...
              <div className="cards">
                ...
                <div className="card">
                  ...
                  <div className="value">{formatPesoValue(overview.totalExpenses)}</div>
                  <div className="progress"><div className="bar" style={{ width: '100%' }} /></div>
                </div>
            ...
            <section className="content-grid">
              <div className="chart-card">
                ...
                <div className="chart-placeholder">
                  {expenses.length === 0 ? 'No expense data yet' : `${expenses.length} expense records loaded`}
                </div>
              </div>
